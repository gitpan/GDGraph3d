...
You use these module just as you would any of the GD::Graph modules, except 
...
You will need to have the GD::Graph version 1.20 or later (recommended 1.22 
or later) installed. You should also have Perl version 5.005.
...
The latest release is available from CPAN: http://www.cpan.org/authors/id/W/WA/WADG/.
